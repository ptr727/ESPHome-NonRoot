...
{
  repository(owner: "ptr727", name: "ESPHome-NonRoot") {
...
gh api repos/ptr727/ESPHome-NonRoot/issues/<N>/comments --jq \
...
- Declined style comment: cite the rule (AGENTS.md) and the existing-tree precedent.
