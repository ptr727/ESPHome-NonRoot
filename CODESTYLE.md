...
Leave human-authored comments and emoji exactly as written. Do not reword, trim, reflow, or "clean" a comment a person wrote, even where it bends a rule above. Revise only agent-authored comments, and match the surrounding voice when you do. The rule to rewrite a comment fresh rather than bolt onto it governs agent-authored comments, and it does not license collapsing a maintainer's comment.
