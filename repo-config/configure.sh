...
cmd_check() {
  ...
  # access to docker.io/ptr727/esphome-nonroot. Verify it by hand in the Docker Hub account.
  note "verify manually: Docker Hub access token valid with push to docker.io/ptr727/esphome-nonroot"
