...
- `.github/` - workflows (the two-layer release pipeline + the ESPHome-version tracker), Dependabot, Copilot instructions, and `esphome-version.json` (the committed upstream-version state file the Docker build reads).
